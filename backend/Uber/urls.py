...
from .views import ChauffeurView, TaxiView, VisiteView, AssuranceView, AgenceView, RegisterView, LoginView, UserViewSet, UserView, LogoutView, CourseView, CourseViewSet, TaxiViewSet
